...
public:
	...
	static void		GravMovement(glm::mat4& a_transform, float a_deltaTime, float a_speed, float floorPos = 0.0f, CollisionMap *cMap = nullptr,const glm::vec3& a_up = glm::vec3(0,1,0));
